...
<head>
    ...
    <title><?php echo e(config('app.name', 'CEFIRE HORARI')); ?></title>
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                    <?php echo e(config('app.name', 'CEFIRE HORARI')); ?>
        ...
        <?php echo $__env->make('modal', ['id' => 'exampleModal'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
